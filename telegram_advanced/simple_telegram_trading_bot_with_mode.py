"""Completed simple Telegram trading bot example with ``/mode`` support.

Run:
  python -m telegram_advanced.simple_telegram_trading_bot_with_mode

Direct execution is also supported:
  python telegram_advanced/simple_telegram_trading_bot_with_mode.py
...
The mode override is held in memory. Restarting the process clears it and makes
...
from telegram_advanced import simple_telegram_commands_with_mode as simple_telegram_commands
